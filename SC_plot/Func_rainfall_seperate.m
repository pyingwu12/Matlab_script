...
for i=1:cyc
    ...
    length_fdir=length(fdir);
    %if(titname(1:7)=='(a)D02S')
    %   %fdir='/SAS003/scyang/WRFEXPSV3/2008IOP8/new/e17_1deg_upper/fcst/wrfout_d03_2008-06-16_01:00:00'
    %   %fdir='/SAS003/scyang/WRFEXPSV3/2008IOP8/D2/e20/fcst/wrfout_d03_2008-06-16_16:00:00';
    %   fdir='/SAS003/scyang/WRFEXPSV3/2008IOP8/D2/e07a/fcst/1518/wrfout_d03_2008-06-16_16:00:00';
    %   Times=getnc(fdir,'Times');
    %elseif(titname(1:7)=='(b)D02D')
    %   %fdir='/SAS003/scyang/WRFEXPSV3/2008IOP8/new/e17_1deg_upper/fcst/wrfout_d03_2008-06-16_01:00:00'
    %   %fdir='/SAS003/scyang/WRFEXPSV3/2008IOP8/D2/e07a/fcst/wrfout_d03_2008-06-16_16:00:00';
    %   nchar=length(fdir)-30;
    %   fdir=[fdir(1:nchar),'wrfout_d03_2008-06-16_06:00:00']
    %   Times=getnc(fdir,'Times');
    %end
    if(size(Times,1)==19)
       n=1;
      fdir=[fdir(1:length_fdir-30),'wrfout_d03_',e_tag]
    else
    for jt=1:size(Times,1)
