...
iplt=1;
tag='2006-09-14_06:00:00';
%files{1}=['../exp06/e07/wrffcst_d01_',tag];
%files{2}=['../exp06/e07/wrfanal_d01_',tag];
files{1}=['../exp06/e09smth/wrfinit_d01_',tag,'.1'];
files{2}=['../exp06/e09smth/wrfsmth_d01_',tag,'.1'];
...
for i=1:4
    ...
    if (i<=3)
        ...
        U=squeeze(0.5*(Utmp(1,19,:,in1)+Utmp(1,19,:,in2)));
        V=squeeze(0.5*(Vtmp(1,19,in1,:)+Vtmp(1,19,in2,:)));
        %clevs=990:1020;
        clevs=205:1.:225;
    end
    switch (i)
