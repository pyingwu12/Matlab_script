...
u1=ve_m(1,:); v1=ve_m(2,:);
uz1=squeeze(vez_m(1,:,:));vz1=squeeze(vez_m(2,:,:));
lons(:,1)=lonc;
lats(:,1)=latc;
...
'fontsize',12,'xticklabel','  ','position',[0.075 0.8 0.9 0.16],'box','on');
...
set(gca,'position',[0.075 0.6 0.9 0.1],'xtick',[0:11],'xticklabel','','box','on',...
'fontsize',12,'yticklabel','','ytick',[5:1])
...
%set(h,'color','k');
%h=quiver([1:nt],ones(1,nt)-1,u2,v2,0.5);
%set(h,'color','b');
%h=quiver([1:nt],ones(1,nt)-1,u3,v3,0.5);
%set(h,'color','r');
%set(gca,'position',[0.05 0.6 0.9 0.15])
%axis([0. 12. -0.5 2.5])
%figure(2);clf
%return
clear X Y;
...
set(gca,'position',[0.075 0.1 0.9 0.4],'xtick',[0:11],'xticklabel','',...
'ytick',[0:0.75:2.25],'yticklabel',num2str(eta(iselect)','%2.2f'),'box','on','fontsize',12)
