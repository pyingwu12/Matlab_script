...
%file='/SAS001/scyang/WRFEXPS/exp09/E28_2/e02RIPB/da_out/wrfanal_d01_2006-09-15_06:00:00';
%yyyy='2006';
%mm='09';
%dd='15';
%hh='12';
...
for j=jj-inc:jj+inc
    ...
    th_p(:,i1,j1)=interp1(p(good),q4(good),log10(levs));
end
end
...
col(end-1,:)=[1,0,1];
colormap(col);
[c,h]=contourf(xd,-1.e-2*levs,1.e3*ws2d',[0:0.55:22]);hold on
caxis([0 22])
%caxis([0 45])
set(h,'linestyle','none');
[c,h]=contour(xd,-1.e-2*levs,th2d',[300:4:380]);
set(h,'linestyle','-','linewidth',1.0,'edgecolor',[0.5 0.5 0.5]);
