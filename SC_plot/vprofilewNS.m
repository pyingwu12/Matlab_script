...
function [xd,levs,ws2d,v2d]=vprofile(file,yyyy,mm,dd,hh,do_plot,slice,lonc0,latc0)
%file='/SAS001/scyang/WRFEXPSV3/sinlaku/smooth_test/wrfinit_d01_2008-09-09_09:00:00.1'
%lonc0=-1;
%latc0=-1;
%yyyy='2008';
%mm='09';
...
col(end-1,:)=[1,0,1];
colormap(col);
[c,h]=contourf(xd,-1.e-2*levs,ws2d',[0:2.4:48]);hold on
%[c,h]=contourf(xd,-1.e-2*levs,ws2d',[0:48/20:48]);hold on
caxis([0 48])%WAF paper
%caxis([0 48])
