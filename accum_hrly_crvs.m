...
%-------------------------------
% 
% expri={'TWIN001B';'TWIN001P';'TWIN002B';'TWIN002P';'TWIN003B';'TWIN003P';'TWIN004B';'TWIN004P'};   exptext='TWIN1_4BP';   bdy=0;  
% expnam={'TWIN001B';'TWIN001P';'TWIN002B';'TWIN002P';'TWIN003B';'TWIN003P';'TWIN004B';'TWIN004P'};
% dom={'01';'01';'01';'01';'01';'01';'01';'01'};
% lexp={'-';'--';'-';'--';'-';'--';'-';'--'};  
% cexp=[0 0.447 0.741;0 0.447 0.741; 0.85,0.325,0.098; 0.85,0.325,0.098; 0.466,0.674,0.188; 0.466,0.674,0.188; 0.494,0.184,0.556; 0.494,0.184,0.556;];
...
% expri={'TWIN001B';'TWIN001Pr01qv21';'TWIN001Pr001qv21';'TWIN001Pr01THM21';'TWIN001Pr001THM21'};   exptext='TWINqv';   bdy=0;  
% expnam={'TWIN001B';'Pr01qv21';'Pr001qv21';'Pr01THM21';'Pr001THM21'};
% dom={'01';'01';'01';'01';'01'};
% lexp={'-';'-';'-';'-';'-'};  
% cexp=[0.3 0.3 0.3;  0.85,0.325,0.098; 0.929,0.694,0.125; 0  0.447  0.741; 0.3,0.745,0.933];
