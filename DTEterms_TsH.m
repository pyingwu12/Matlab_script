...
%contours---
wcol=[0.88 0.1 0]; thecol=[0.98 0.7 0]; 
%
...
LSpac=600; Lfs=20; linw=2.4;

%---hydrometeors
[c,hdis]=contour(xi,zi,hyd2_m*1e3,[0.1 0.1],'linewidth',linw+0.2,'color',[0.2 0.2 0.2],'linestyle','--');
clabel(c,hdis,[0.1 5 6 7 8 10],'fontsize',Lfs,'color',[0.2 0.2 0.2],'LabelSpacing',300)   

[c,hdis]=contour(xi,zi,hyd2_m*1e3,[7 7],'linewidth',linw,'color',[0 0 0],'linestyle','--');
clabel(c,hdis,[0.1 5 6 7 8 10],'fontsize',Lfs,'color',[0 0 0],'LabelSpacing',300)   


%---horizontal max updraft of cntl simulation
[c,hdis]=contour(xi,zi,w_m,[1.5 1.5],'color',wcol,'linewidth',linw+0.2,'linestyle','--'); 
clabel(c,hdis,[1 1.5 2 5 6 7 10 11 12 13 14 15],'fontsize',Lfs,'color',wcol,'LabelSpacing',300)   
wcol2=[1 0 0];
[c,hdis]=contour(xi,zi,w_m,[15 15],'color',wcol2,'linewidth',linw,'linestyle','--'); 
clabel(c,hdis,[1 1.5 2 5 6 7 10 11 12 13 14 15],'fontsize',Lfs,'color',wcol2,'LabelSpacing',300)   


%---horizontal max of theta'---
[c,hdis]=contour(xi,zi,theta_ano_max,[1 1],'color',thecol,'linewidth',linw+0.2,'linestyle','--'); 
clabel(c,hdis,[0.5 1 2 2.5 3 3.5 4 ],'fontsize',Lfs,'color',thecol,'LabelSpacing',200)   
% thecol2=thecol-[0.1 0.1 0.1]; thecol2(thecol2<0)=0;
 thecol2=[0.97 0.9 0]; 
[c,hdis]=contour(xi,zi,theta_ano_max,[4 4],'color',thecol2,'linewidth',linw,'linestyle','--'); 
