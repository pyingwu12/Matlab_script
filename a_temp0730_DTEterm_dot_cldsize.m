...
% stday=23;   hrs=2;  minu=00;
stday=22;   hrs=[27 26 25 24 23];  minu=[50 20];  
...
titnam=['size of cloud area to ',ploterm];   fignam=[expri1,'_cloud-',ploterm,'_'];
%
...
set(gca,'XLim',[3.5 1e2],'YLim',[5e-2 3e2])
