...
pltime=19; expnam='H01MultiE0206'; infilename='201910111800'; expsize=1000;  %hagibis01e06
%
...
titnam=[expnam,'  Wind speed probab.'];   fignam0=[expnam,'_wind-prob_'];   unit='%';
%
...
% plon=[135.5 142.5]; plat=[33.5 37]; fignam=[fignam,'zkd_'];   lo_int=135:5:145; la_int=30:5:40; % old230306 zoom in Kantou area
plon=[135.5 142.3]; plat=[33.5 37.3]; fignam=[fignam0,'zkd2_'];  lo_int=134:2:145; la_int=31:2:40; % zoom in Kantou area
...
%     set(hc,'position',[0.8 0.13 0.02 0.74]);
 ...
 m_plot(lon_o(fin),lat_o(fin),'x','color',[0.9 0.05 0.7],'linewidth',2.2,'Markersize',10)
