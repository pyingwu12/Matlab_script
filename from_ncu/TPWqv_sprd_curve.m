%-------------------------------------------------------
% plot the time series of the total Qv spread 
%-------------------------------------------------------
%clear
...
%
varinam='total qv spread';    filenam=[expri,'_TPWqv-sprdt_'];  
%---
sprd=TPWqv_sprd_mean(hr,minu,year,mon,date,expri,memsize);
%%
%---plot---------------
nti=0;
for ti=hr;
