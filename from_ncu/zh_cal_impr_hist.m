function hi=zh_cal_impr_hist(expdir,range,hm,day,dom,obsdir,landid)
%-----------------------------------
% cal hist of Zh improvement after DA
%-----------------------------------
