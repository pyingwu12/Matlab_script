...
%%
%---
% plon=[138.5 141]; plat=[34 36.5];  fignam=[expri,'_terr_Kanto_p'];
plon=[139.2 140.9]; plat=[34.85 36.3 ];  fignam=[expri,'_terr_tokyobay']; 

titnam=[expri,'  Terrain'];  
...
%%
% plon=[138.5 141]; plat=[34 36.5];  fignam=[expri,'_land_Kanto_p'];
plon=[139.2 140.9]; plat=[34.85 36.3 ];  fignam=[expri,'_land_tokyobay'];

land(land+1==1)=0;
land(land+1==2)=1;
titnam=[expri,'  land-sea ratio'];  
...
%%
% plon=[138.5 141]; plat=[34 36.5];  fignam=[expri,'_rough_Kanto_p'];
plon=[139.2 140.9]; plat=[34.85 36.3 ];  fignam=[expri,'_rough_tokyobay']; 

titnam=[expri,'  Roughness'];  
