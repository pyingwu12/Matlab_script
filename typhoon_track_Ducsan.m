...
lon_track(lon_track==0) =NaN; lat_track(lat_track==0) =NaN;
%%
%--best track
...
% m_text(lon_track(end,imem),lat_track(end,imem),num2str(imem))
drawnow
end
...
% m_plot(lon_track(:,mem_best),lat_track(:,mem_best),'color',[0.1 0.1 0.9],'Linewidth',1); 
%---
% m_coast('color','k');
