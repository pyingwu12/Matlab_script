...
for i=1:nexp
   plotvar(i,:)=cal_hfx(indir,expri{i},ymdm,sth,lenh,dom{i},bdy,typst,ccc);
   disp([expri{i},' done'])
end
...
%
legh=legend(expnam,'Box','off','Interpreter','none','fontsize',18,'Location','n');
%
set(gca,'XLim',[1 lenh],'XTick',tint:tint:lenh,'XTickLabel',ss_hr,'fontsize',16,'linewidth',1.2)
xlabel('Time (JST)');  ylabel('Heat Flux (Wm^-^2)')
