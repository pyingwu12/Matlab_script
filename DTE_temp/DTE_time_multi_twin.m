...
%---
expri1={'TWIN001Pr001THM062221';'TWIN003Pr001THM062221'};   exptext='13THM062221a1';
...
titnam='DTE (volume average)';   fignam=['DTE_',exptext,'_'];
...
xlabel('Time(JST)'); ylabel('DTE (JKg^-^1K^-^1)')  
