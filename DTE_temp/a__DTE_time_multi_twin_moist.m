...
%----
%---set experiments---
expri1={'TWIN001Pr001qv062218';'TWIN003Pr001qv062218';'TWIN004Pr001qv062218'};   exptext='134qv062218';
...
%---setting---
sth=18;  lenh=24;  minu=00;  tint=2;
ymd='20180622';  
%
indir='/mnt/HDD008/pwin/Experiments/expri_twin';
outdir='/mnt/e/figures/expri_twin';
%
titnam='moist DTE (area mean)';   fignam=['twin_moDTE_',exptext,'_'];
nexp=size(expri1,1);
...
for ei=1:nexp
  DTE=cal_DTEmo_twin(indir,expri1{ei},expri2{ei},ymd,sth,lenh,minu,ccc); 
  for ti=1:ntime
