...
%
% pltime=43; expri='Hagibis05kme02'; infilename='201910101800';%hagibis
...
%plon=[135.5 142.5]; plat=[33.5 37]; fignam=[expri,'_wind-spagh2_']; 
...
%%
% titnam=[expri,'  Wind speed'];    fignam=[expri,'_wind-spagh_']; 
% plon=[135 144.5]; plat=[32 39];  lo_int=136:2:144; la_int=33:2:37; % wide Kantou area
