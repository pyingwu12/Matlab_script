...
%---
titnam='Accumulated Rainfall';   fignam=[expri1,'_rain-twin-ctr_'];
...
for ti=sth
  ...
  for ai=acch
    ...
    hold on
    contour(rain2',[10 10],'color',[0.1 0.1 0.1],'linestyle','-','linewidth',3)
...
%     contour(rain2',[10 10],'color',[0.3 0.3 0.3],'linewidth',2.4); hold on 
%     contour(rain2',[10 10],'color',[0.4 0.7 0.9],'linewidth',1.5,'linestyle','--'); 
% 
%     if (max(max(hgt))~=0)
%      contour(hgt',[100 500 900],'color',[0.65 0.65 0.65],'linestyle','--','linewidth',2.5); 
%     end
...
%     title(tit,'fontsize',18)
    ...
    outfile=[outdir,'/',fignam,'d',dom,'_',mon,num2str(stday),'_',s_sth,s_minu,'_',num2str(ai),'h_4'];
    if saveid==1
