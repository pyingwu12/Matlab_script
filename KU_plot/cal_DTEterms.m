function [DTE, P]=cal_DTEterms(infile1,infile2)
...
%---infile 1---
 ...
 p=ncread(infile1,'P');  pb = ncread(infile1,'PB');  P.f1 = double(pb+p)/100;
 th.f1=double(ncread(infile1,'T'))+300; 
