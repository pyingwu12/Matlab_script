...
close all
%---setting
expri='ens03';   member=1:10;    lev=5;  % !! 1 member, 1 level
...
%---
tit=[expri,'  ',titnam,'  lev',num2str(lev,'%.2d'),', mean'];     
title(tit,'fontsize',18)
outfile=[outdir,'/',fignam,num2str(sth),minu,'_',num2str(lenh),'h_lev',num2str(lev,'%.2d'),'_mean'];
