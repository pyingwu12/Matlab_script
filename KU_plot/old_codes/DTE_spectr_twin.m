...
stday=23;    minu=0;  lev=1:17;  
hrs=[21 22 23 24 25 26 27 28 29 31 33];
% hrs=[0 1 2];
%--
year='2018';  mon='06';
...
outfile=[outdir,'/',fignam,'d',dom,'_',mon,num2str(stday),'_',s_sth,s_edh,'_',num2str(lenhr),'hrs',num2str(length(minu)),'min_lev',num2str(lev(1),'%.2d'),num2str(lev(end),'%.2d')];
