...
%     hf=figure('position',[100 45 800 680]);  
    ...
    if (max(max(hgt))~=0)
         hold on; contour(hgt_extend',[100 500 900],'color',[0.5 0.5 0.5],'linestyle','--','linewidth',3); 

%          hold on; contour(hgt_extend',[100 500 900],'color',[0.2 0.6 0.4],'linestyle','--','linewidth',4); 
    end
    hold on
