...
hf=figure('position',[50 200 1150 600]);

ax1=subplot(1,3,1);
set(ax1,'position',[0.09 0.1406 0.2099 0.7844])
plot(Wind(:,4),h(1:end),'linewidth',3.5,'color',s_col);hold on
plot([270 270],[0 h(end-1)],'linewidth',3.5,'color',U25_col);
plot([270 270],[0 h(end-1)],'linewidth',3.5,'color',NS5_col,'linestyle',':');
  xlabel(ax1,'Direction','position',[180 -2.8 -1.0000]);  ylabel(ax1,'Height (km)')
    set(ax1,'linewidth',1.2,'fontsize',20,'Ylim',[0 27],'Xlim',[0 360],'xtick',[0 90 180 270 360],'xticklabel',{'N','E','S','W'})

ax2=subplot(1,3,2);
set(ax2,'position',[0.35 0.1406 0.2099 0.7844])
plot(spd,h,'linewidth',3.5,'color',s_col);  hold on
plot(U25,h,'linewidth',3.5,'color',U25_col);
plot([5 5],[0 h(end)],'linewidth',3.5,'color',NS5_col,'linestyle',':');
plot([0 0],[0 h(end)],'linewidth',3.5,'color',U00_col,'linestyle','--');
  xlabel(ax2,'Speed (m s^-^1)','position',[15 -2.4 -1.0000]);
    set(ax2,'linewidth',1.2,'fontsize',20,'Ylim',[0 27],'Xlim',[0 30])
...
ploth(3)=plot([0 0],[0 h(end-1)],'linewidth',3.5,'color',U00_col,'linestyle','--');
  ...
  set(hlg,'position',[0.75  0.183  0.16  0.25])
