...
% 2021/11/06: change cloud area criteria to TPW=0.7
...
stday=22;   hrs=[26 25 24 23];  minu=50:-10:0;  
% stday=23;   hrs=2;  minu=0;
% stday=22;   hrs=[27 26 25 24 23];  minu=[30 0]; 

xsub1=1; xsub2=300; ysub1=76; ysub2=225;
...
titnam=['size of cloud area to ',ploterm];   fignam=[expri1(8:end),'_cloud-',ploterm,'-sub_'];
%
...
%     cloud=cal_cloudarea_1time(infile1,infile2,areasize,cloudhyd,ploterm);    
     cloud=cal_cloudarea_1time_subdom(infile1,infile2,areasize,cloudtpw,ploterm,xsub1,xsub2,ysub1,ysub2);
...
legend(lgnd,'Interpreter','none','fontsize',12,'Location','bestoutside');
...
outfile=[outdir,'/',fignam,mon,num2str(stday),'_',s_sth,s_edh,'_',num2str(nhr),'h',num2str(nminu),'m',num2str(minu(end)),'_tpw',num2str(cloudtpw)];
