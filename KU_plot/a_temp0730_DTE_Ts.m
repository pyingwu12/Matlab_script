...
%---experiments
expri1={'TWIN001Pr001qv062221';'TWIN003Pr001qv062221'};   exptext='temp0730';
...
plot(DTE_am(1,:,2),linestyl{2},'LineWidth',5,'color',cexp(1,:));hold on
plot(DTE_am(2,:,1),linestyl{1},'LineWidth',5,'color',cexp(2,:))
for ei=1:nexp
%   plot(DTE_dm(ei,:),'LineWidth',5,'color',cexp(ei,:)); hold on
  if plotarea~=0
    for ai=1:narea
      plot(DTE_am(ei,:,ai),linestyl{ai},'LineWidth',5,'color',cexp(ei,:));hold on
    end
  end
end
