...
%----
%---set experiments---
expri1={'TWIN001B';'TWIN001Pr001qv21';'TWIN003Pr001qv21'};   exptext='1B5B_13qv21';
expri2={'TWIN005B';'TWIN001B';'TWIN003B'};
expnam={'1B-5B';'1Pr001qv21';'3Pr001qv21'};
col=[0 0.447 0.741;  0.3,0.745,0.933; 0.85,0.325,0.098; ]; 
...
%
titnam='area mean DTE';   fignam=['twinDTE_',exptext,'_'];
nexp=size(expri1,1);
