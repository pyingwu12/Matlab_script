...
%---setting---
stday=22;  sth=21;  lenh=20;  minu=[0 20 40];  tint=2;  varinam='U';  lev=[1:17]; %[]=all levels
ylogid=1;  plotarea=1;
%
year='2018'; mon='06';  infilenam='wrfout'; dom='01';  
%---
indir='/mnt/HDD008/pwin/Experiments/expri_twin';  outdir='/mnt/e/figures/expri_twin';
titnam=[varinam,' root mean square difference'];   fignam=[varinam,'RMSD_',exptext,'_'];
...
for ei=1:nexp
  ...
  for ti=1:lenh    
    ...
    for tmi=minu
      ...
      vari =  ncread(infile1,varinam); 
      if isempty(lev); vari1=vari; else; vari1=vari(:,:,lev); end
%       vari1 = double( ncread(infile1,varinam) )*10^3; 
      %---infile 2---
      infile2=[indir,'/',expri2{ei},'/',infilenam,'_d',dom,'_',year,'-',mon,'-',s_date,'_',s_hr,ccc,s_min,ccc,'00'];
      vari =  ncread(infile2,varinam); 
      if isempty(lev); vari2=vari; else; vari2=vari(:,:,lev); end
%       vari2 = double( ncread(infile2,varinam) )*10^3; 
      %---difference square
      diff2 = (vari1-vari2).^2;
      %---root mean
