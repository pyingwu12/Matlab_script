...
% exptext='test';
% expri1={'TWIN201Pr001qv062221mem4';'TWIN003Pr001qv062221mem4'};   
% expri2={'TWIN201B';'TWIN003B'}; 
% expnam={'FLAT';'TOPO'};
% cexp=[87 198 229; 242 155 0; 146 200 101; 230 70 80; 239 154 183]/255;   


% expri1={'TWIN201Pr001qv062221';'TWIN201Pr001qv062221mem2';'TWIN201Pr001qv062221mem3';'TWIN201Pr001qv062221mem4';
%         'TWIN003Pr001qv062221';'TWIN003Pr001qv062221mem2';'TWIN003Pr001qv062221mem3';'TWIN003Pr001qv062221mem4';
%         'TWIN013Pr001qv062221';'TWIN013Pr001qv062221mem3';'TWIN013Pr001qv062221mem4'
%         'TWIN021Pr001qv062221';'TWIN021Pr001qv062221mem2';'TWIN021Pr001qv062221mem3';'TWIN021Pr001qv062221mem4'
%         'TWIN020Pr001qv062221';'TWIN020Pr001qv062221mem2';'TWIN020Pr001qv062221mem3'};   
% expri2={'TWIN201B';'TWIN201B';'TWIN201B'; 'TWIN201B';
%     'TWIN003B';'TWIN003B';'TWIN003B';'TWIN003B';
%     'TWIN013B';'TWIN013B';'TWIN013B';
%     'TWIN021B';'TWIN021B';'TWIN021B';'TWIN021B';
%     'TWIN020B';'TWIN020B';'TWIN020B'}; 
% exptext='test';
% expnam={'FLAT';'TOPO';'H500';'V05';'V20'};
% % cexp=[87 198 229; 242 155 0; 146 200 101; 230 70 80; 239 154 183]/255;
% 
% cexp=[87 198 229; 87 198 229; 87 198 229; 87 198 229; 
%     242 155 0;  242 155 0;  242 155 0;  242 155 0;
%     146 200 101; 146 200 101; 146 200 101; 
%     230 70 80; 230 70 80; 230 70 80; 230 70 80; 
%     239 154 183; 239 154 183; 239 154 183]/255;


% expri1={ 'TWIN030Pr001qv062221'; 'TWIN031Pr001qv062221';'TWIN042Pr001qv062221';'TWIN043Pr001qv062221'};   
...
expri1={'TWIN030Pr001qv062221';'TWIN030Pr001qv062221mem2';'TWIN030Pr001qv062221mem3';
        'TWIN031Pr001qv062221';'TWIN031Pr001qv062221mem2';'TWIN031Pr001qv062221mem3';
        'TWIN042Pr001qv062221';'TWIN042Pr001qv062221mem2';'TWIN042Pr001qv062221mem3';
        'TWIN043Pr001qv062221';'TWIN043Pr001qv062221mem2';'TWIN043Pr001qv062221mem3'};   
expri2={'TWIN030B';'TWIN030B';'TWIN030B';
    'TWIN031B';'TWIN031B';'TWIN031B';
    'TWIN042B';'TWIN042B';'TWIN042B';
    'TWIN043B';'TWIN043B';'TWIN043B'}; 
exptext='test';
expnam={'NS5_FLAT';'NS5_TOPO';'U00_FLAT';'U00_TOPO'};
cexp=[ 44 125 190;  44 125 190;   44 125 190; 
    232 66 44;    232 66 44; 232 66 44;
    95 85 147;     95 85 147;     95 85 147; 
   168 63 63  ;168 63 63  ;168 63 63]/255; 
...
%   h(colei)=plot(rain_score(ei,:),'LineWidth',3,'color',cexp(colei,:)); hold on
  ...
  h(ei)=plot(rain_score(ei,:),'LineWidth',5,'color',cexp(ei,:),'linestyle','-'); hold on
