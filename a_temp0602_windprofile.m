...
outfile='D:/figures/expri_twin/wind_profiles_U00NS5';
...
hf=figure('position',[50 200 800 600]);
...
%   xlabel(ax1,'Direction','position',[180 -2.5 -1.0000]); 
...
%   xlabel(ax2,'Speed (m s^-^1)','position',[15 -2.1 -1.0000]);
    set(ax2,'linewidth',1.2,'fontsize',20,'Ylim',[0 27],'Xlim',[0 25],'XTick',[0 5 10 15 20]) 
title('wind speed')
