...
hr=0;   minu='00';   expri='largens';   member=1:30:256;
...
cmap=colormap_qr3;
%---
varinam='total-qr';    filenam=[expri,'_TPWqr_'];  
...
%---plot---
      ...
      %
      tit=[expri,'  ',varinam,'  ',s_hr,minu,'z (mem',nen,', ',type,')'];   
      if wid~=0; tit=[tit,' (',num2str(hgt_w/1000),'km wind)']; end
