%function q_dasprd(hr,expri,varind)
clear
hr=17; expri='DA1517vrzh';   varind=2;  type='fcst';
...
%---set filename---    
   ...
   for mi=1:40   
     nen=num2str(mi);
     if mi<=9
       infile=[indir,'/cycle0',nen,'/',type,'_d03_2009-08-',s_date,'_',s_hr,':00:00'];
       %infile=[indir,'/wrfout_d03_2009-08-',s_date,'_',s_hr,':00:00_0',nen];
     else
       infile=[indir,'/cycle',nen,'/',type,'_d03_2009-08-',s_date,'_',s_hr,':00:00'];
