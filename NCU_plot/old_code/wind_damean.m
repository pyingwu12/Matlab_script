...
spid=1; hr=17; expri='MRcycle05';  type0='fcst';  %test
addpath('/work/zerocustom/matlabLibrary/m_map_v1.4f/')
addpath('/work/pwin/data/colorbar/')
load '/work/pwin/data/colormap_wind.mat'
%----set----
vari='wind';   filenam=[expri,'_wind_'];  type=[type0,'mean'];
...
%---plot
   ...
   m_proj('Lambert','lon',[118.5 122.5],'lat',[21.65 25.65],'clongitude',121,'parallels',[33.65 13.65],'rectbox','on')
   if spid~=0
     L2=[min(min(sp(:,:,lev))),L];
