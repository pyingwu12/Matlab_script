function vr_inno(hm,sw,expri,zmind)
...
%---setting---
vari='Vr innovation';   filenam=[expri,'_vr-ino_'];  
num=size(hm,1);
...
%===obs===
  ...
  vr1 =A(:,8);  
%===wrf===    
  %infile2=[indir,'/wrfout_d03_2009-08-08_',time,':00_mean'];
  infile2=[indir,'/fcstmean_d03_2009-08-08_',time,':00'];
...
%---plot---
    plot_radar(ino_sw,lon_sw,lat_sw,cmap,L,zmind) %%%----plot function
