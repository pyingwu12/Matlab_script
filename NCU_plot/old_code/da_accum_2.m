...
%---read data---    
      infile=['acci_',s_sth,s_min,s_edh,s_min,'_da.mat'];  %%%
      load (infile);
...
%---mean---
      if plotid==1 || plotid==3 || plotid==5 || plotid==7
        ...
        outfile=[filenam,s_sth,s_edh,'_',type1,'.png'];
...
%---PM---   
      if plotid==2 || plotid==3 || plotid==6 || plotid==7
        ...
        tit=[expri,'  ',vari,'  ',s_sth,s_min,'z -',s_edh,s_min,'z','  (',type2,')'];
        title(tit,'fontsize',15)
        outfile=[filenam,s_sth,s_min,s_edh,s_min,'_',type2,'.png'];
        print('-dpng',outfile,'-r350')       
      end
%---PMmod---
      if plotid==4 || plotid==5 || plotid==6 || plotid==7
        ...
        title(tit,'fontsize',15)
        outfile=[filenam,s_sth,s_edh,'_',type3,'.png'];
        print('-dpng',outfile,'-r350')     
      end
   end
end  
