...
% output: mean, PM mean(Ebert,2001), Pmmod mean(Yeh,2014)
      ...
      [sortmeacci,loc]=sort(rmeacci);             % loc : the location in original rmeacci of sortmeacci(1.2.3...)
      %--give the pattern to PM and PMmod--
      pm=zeros(xl*yl,1);
      pmmod=zeros(xl*yl,1);
      for k=1:xl*yl   % 41*81 = 3321    
