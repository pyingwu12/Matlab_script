...
load '/work/pwin/data/colormap_qr.mat'; clim=[0 6]; 
%-----------set filename---------------------------
type='mean';  
expri='original';   vari='max qrain';   filenam='ori_maxqr_';  
%hm=['15:00';'16:00';'17:00';'18:00';'19:00';'20:00'];  %time
hm='15:00';
num=size(hm,1);
%---
cfind=1; %
...
for ti=1:num;
   time=hm(ti,:);
   infile=['/SAS004/pwin/wrfout_morakot_orig_1200/wrfout_d03_2009-08-08_',time,':00_mean'];
%------read netcdf data--------
...
%---plot---
   ...
   if cfind~=0; 
     ...
     [c hp]=m_contour(x,y,qrmax,[1 2 3],'color',[0.4 0.5 0.4],'LineWidth',1.2);   
